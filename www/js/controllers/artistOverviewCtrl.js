(function() {
	...
	artistOverviewCtrl.$inject = ['$scope', 'dataFactory', 'artistFactory', 'loaderFactory', '$state', '$stateParams'];

	function artistOverviewCtrl($scope, dataFactory, artistFactory, loaderFactory, $state, $stateParams) {
